...
internal class NetworkTests {
    ...
    fun initShouldThrowsExceptionWhenSomeComputersHasInCorrectLinks() {
        ...
        val healthComputer1 = Computer(OperationSystem.Windows, linksForHealthComputer1, false)
        val healthComputer2 = Computer(OperationSystem.Linux, linksForHealthComputer2, false)
        val healthComputer3 = Computer(OperationSystem.Mac, linksForHealthComputer3, false)
        val infectedComputer1 = Computer(OperationSystem.Windows, linksForInfectedComputer1, true)
        val infectedComputer2 = Computer(OperationSystem.Linux, linksForInfectedComputer2, true)
        val infectedComputer3 = Computer(OperationSystem.Mac, linksForInfectedComputer3, true)
    ...
    fun infectShouldWorksCorrectlyWhenNetworkHasManyInfectedComputers() {
        ...
        val healthComputer2 = Computer(OperationSystem.Linux, linksForHealthComputer2, false)
        val healthComputer3 = Computer(OperationSystem.Mac, linksForHealthComputer3, false)
        val healthComputer4 = Computer(OperationSystem.Windows, linksForHealthComputer4, false)
        val healthComputer5 = Computer(OperationSystem.Windows, linksForHealthComputer5, false)
        val healthComputer6 = Computer(OperationSystem.Windows, linksForHealthComputer6, false)
        val infectedComputer1 = Computer(OperationSystem.Windows, linksForInfectedComputer1, true)
        val infectedComputer2 = Computer(OperationSystem.Windows, linksForInfectedComputer2, true)
        val infectedComputer3 = Computer(OperationSystem.Windows, linksForInfectedComputer3, true)
        val infectedComputer4 = Computer(OperationSystem.Linux, linksForInfectedComputer4, true)
        val infectedComputer5 = Computer(OperationSystem.Mac, linksForInfectedComputer5, true)
